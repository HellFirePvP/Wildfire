...
public class RenderingUtils {
    ...
    private static void renderColoredQuads(BufferBuilder renderer, java.util.List<BakedQuad> quads, Color color, ItemStack stack) {
    ...
    public static void renderBlueStackTooltip(int x, int y, java.util.List<Tuple<ItemStack, String>> tooltipData, FontRenderer fr, RenderItem ri) {
        renderStackTooltip(x, y, tooltipData, new Color(0x000027), new Color(0x000044), Color.WHITE, fr, ri);
    }

    public static void renderStackTooltip(int x, int y, java.util.List<Tuple<ItemStack, String>> tooltipData, Color color, Color colorFade, Color strColor, FontRenderer fr, RenderItem ri) {
    ...
    public static void renderBlueTooltip(int x, int y, java.util.List<String> tooltipData, FontRenderer fontRenderer) {
